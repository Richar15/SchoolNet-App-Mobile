...
class TestScreen extends StatelessWidget {
  ...
  const TestScreen({super.key, required this.authData});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Bienvenido a SchoolNet', style: TextStyle(color: AppColors.white)),
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: AppColors.whiteTransparent, // Fondo semi-transparente
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 10),
                    // Aquí se usa el operador de aserción de no nulidad '!'
                    Text(
                      'Token (parcial): ${authData.token!.substring(0, 20)}...',
