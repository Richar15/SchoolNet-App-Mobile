...
class _RegisterStudentScreenState extends State<RegisterStudentScreen> {
  ...
  void _performRegistration() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        final studentData = StudentRequestDTO(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildTextField(
                        ...
                        labelText: 'Teléfono',
                        hintText: '+573001234567', // Ejemplo de hint
                        icon: Icons.phone,
                        keyboardType: TextInputType.phone,
                        validator: _validatePhone, // Usamos la nueva validación
                      ),
                      const SizedBox(height: 20),
                      _buildTextField(
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: const Icon(Icons.school_outlined, color: AppColors.white),
                        ),
                        ...
                        validator: (value) => _validateRequired(value, 'grado'),
                      ),
